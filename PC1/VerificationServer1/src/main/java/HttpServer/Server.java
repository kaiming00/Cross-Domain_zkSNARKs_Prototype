...
public class Server {
    ...
    private static class VerifyHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            System.out.println("(Time cost test) ***************** VS ID Hide (IH) start!");
            ...
            if (verify) {
//                System.out.println("Shadow check successfully!");
                ...
                verify = TransformUtils.checkProof(c, parametersA,
                        ...
                        proof);
//                System.out.println("Start update the blockchain : "+verify);
            ...
            if (verify){
//                System.out.println("Verification successful! Blockchain state updated!");
            }
...
//            System.out.println(verify);
            ...
            System.out.printf("(Time cost test) ***************** VS ID Hide (IH) finished, time is %d ms.\n", (etime-stime));
