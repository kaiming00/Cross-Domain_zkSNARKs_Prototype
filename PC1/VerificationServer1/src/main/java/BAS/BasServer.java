...
public class BasServer {
    ...
    public static final String userId = "Org1User1";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            server.start();
            System.out.println("VS1 in domain A is on!");
    ...
    private static class VerifyHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            FileOutputStream out = new FileOutputStream("./LOG/VS1.csv",true);
            ...
            try {
                ...
                for (int k=0;k<vsT-1;k++){
                    ...
                    mulResult1 = mulResult1.duplicate().mul(temp.pow(BigInteger.valueOf((long)Math.pow(1, k+1))));
                }
                ...
                for (int k=0;k<vsT-1;k++){
                    ...
                    mulResult2 = mulResult2.duplicate().mul(temp.pow(BigInteger.valueOf((long)Math.pow(1, k+1))));
                }
                ...
                for (int k=0;k<vsT-1;k++){
                    ...
                    mulResult3 = mulResult3.duplicate().mul(temp.pow(BigInteger.valueOf((long)Math.pow(1, k+1))));
                }
                mulResult3 = mulResult3.duplicate().mul(Y3);

                verify = gs1.isEqual(mulResult1) && gs2.isEqual(mulResult2) && gs3.isEqual(mulResult3);
                ps.println("computation verify result is : "+ verify);
                if (verify) {
                    ...
                    verify = TransformUtils.checkProof(c, parametersA,
                            ...
                            proof);
                    ps.println("proof check result is: "+verify);
            ...
            ps.println("return result is : "+verify);
            Map<String,String> sendMap = new HashMap<>();
    ...
    private static class QueryIdentityInfoHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            FileOutputStream out = new FileOutputStream("./LOG/VS1_"+System.currentTimeMillis()+"_log.csv",true);
            ...
            long etime = System.currentTimeMillis();
            ps.println("VS1_AU_cost, "+(etime-stime));
            ps.close();
            out.close();
        }
    }
