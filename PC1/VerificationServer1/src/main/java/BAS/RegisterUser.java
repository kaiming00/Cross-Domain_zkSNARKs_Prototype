...
public class RegisterUser {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String certPEM = Files.readString(Paths.get("../network/crypto-config/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp/signcerts/User1@org1.example.com-cert.pem"));
        String keyPEM = Files.readString(Paths.get("../network/crypto-config/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp/keystore/priv_sk"));
